        ...
        Column(
            ...
            Button(
                onClick = {
                    ...
                    // ✅✅✅ CORREÇÃO (Linha 175 - "Smart Cast") ✅✅✅
                    // Criamos uma cópia local 'val' para evitar o erro
                    ...
                    if (isEditMode && eventoParaSalvar != null) {
                        ...
                        val eventoAtualizado = eventoParaSalvar.copy(
                            ...
                            isSynced = false,
                            // ✅✅✅ CORREÇÃO (Linha 182) ✅✅✅
                            // Agora 'valor' é um parâmetro válido
                            valor = if (tipoEvento == "Peso") valorDouble else null
                        )
                        eventoViewModel.updateEvento(eventoAtualizado)
                        Toast.makeText(context, "Evento '$tipoEvento' atualizado!", Toast.LENGTH_SHORT).show()
